...
export class Status extends Entity {
  ...
  get gravatarCount(): BigInt | null {
    let value = this.get("gravatarCount");
    if (value === null || value.kind == ValueKind.NULL) {
      return null;
    } else {
  ...
  set gravatarCount(value: BigInt | null) {
    if (value === null) {
      this.unset("gravatarCount");
    } else {
      this.set("gravatarCount", Value.fromBigInt(value as BigInt));
    }
  }
}
